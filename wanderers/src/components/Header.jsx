...
function Header({ type }) {
  ...
  const handleSearch = () => {
    ...
    localStorage.setItem("dates", JSON.stringify({ destination, dates, options }));
  ...
  return (
    <div className="header">
      ...
      >
        ...
        {type !== "list" && (
          <>
            <h1 className="headerTitle">Take memories, leave footprints.</h1>
            <p>Flat 20% Off for SUMMER</p>
